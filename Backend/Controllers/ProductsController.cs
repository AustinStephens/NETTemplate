...
namespace Backend.Controllers
{
    public class ProductsController : BaseApiController
    {
        ...
        {
            IQueryable<Product> query = _context.Products.Sort(productParams.OrderBy).Search(productParams.SearchTerm).Filter(productParams.Brands, productParams.Types).AsQueryable();
