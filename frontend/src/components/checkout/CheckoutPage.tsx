...
export default function CheckoutPage() {
    ...
    async function submitOrder(data: FieldValues) {
        ...
        try {
            const cardElement = elements.getElement(CardNumberElement); // gives us all 3
            ...
            if(paymentResult.paymentIntent?.status === 'succeeded') {
                const orderNumber = await dispatch(createOrderAsync({saveAddress, shippingAddress})).unwrap();
                setOrderNumber(parseInt(orderNumber));
